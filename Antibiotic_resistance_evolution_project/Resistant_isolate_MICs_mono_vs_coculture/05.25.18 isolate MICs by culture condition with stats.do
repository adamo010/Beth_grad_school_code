...
clear
use "C:\Users\adamo\OneDrive\Documents\Harcombe_lab\AbR_evolution\Data analysis in Stata\Resistant isolate MICs in mono vs coculture\05.25.18 isolate MICs by culture condition with stats.dta"
...
*Stats for evolved resistant in mono vs. coop
...
text(7.9 4 "p=0.0181", size(small))
...
text(8.8 10 "p=0.0172", size(small))
...
text(7.7 4 "p=0.0001", size(small))
...
ylabel(#10, angle(horizontal) labsize(medsmall)) ///
xtitle("") ///
ylabel(-1(1)10, labsize(medsmall)) yscale(range(-1 10)) ///
text(9.8 10 "p=0.0243", size(small))
