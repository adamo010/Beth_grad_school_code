...
aspectratio(0.9) ///
text(0.72 2 "p=0.06656", size(small)) text(0.65 2.5 "p<0.00001", size(small)) text(0.78 3 "p=0.0401", size(small)) text(0.65 4 "p=0.1256", size(small))
...
text(0.75 8 "p=0.0041", size(small)) text(0.7 8.5 "p=0.0003", size(small)) text(0.88 9 "p=0.0025", size(small)) text(0.79 10 "p=0.2154", size(small))
...
ylabel(0(0.1)0.8, labsize(medsmall)) yscale(range(0 0.8)) ///
aspectratio(0.9) ///
text(0.73 2 "p<0.00001", size(small)) text(0.66 2.5 "p<0.00001", size(small)) text(0.79 3 "p<0.00001", size(small)) text(0.67 4 "p=0.1256", size(small))
...
ylabel(0(0.1)0.9, labsize(medsmall)) yscale(range(0 0.9)) ///
aspectratio(0.7, placement(left)) ///
text(0.72 8 "p<0.00001", size(small)) text(0.67 8.5 "p=0.0003", size(small)) text(0.88 9 "p=0.0038", size(small)) text(0.76 10 "p=0.2154", size(small))
