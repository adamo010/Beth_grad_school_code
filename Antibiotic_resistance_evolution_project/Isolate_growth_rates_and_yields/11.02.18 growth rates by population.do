...
title("Rifampicin, monoculture-evolved {it:E. coli}," "Monoculture growth rates", size(medlarge) color(black) margin(zero)) ///
...
stripplot coop_gr if ab=="Rif" & dumb_shit==3, over(repdummy) /// 
 stack center vertical refline(lwidth(0.4) lcolor(black)) separate(dumb_shit) ///
title("Rifampicin, monoculture-evolved {it:E. coli}," "co-culture growth rates", size(medlarge) color(black) margin(zero)) ///
...
stripplot mono_gr if ab=="Rif" & dumb_shit==5, over(repdummy) /// 
 stack center vertical refline(lwidth(0.4) lcolor(black)) separate(dumb_shit) ///
title("Rifampicin, coculture-evolved {it:E. coli}," "monoculture growth rates", size(medlarge) color(black) margin(zero)) ///
ytitle("Monoculture growth rate", size(medsmall)) ///
xtitle("Population name", size(medsmall) margin(vsmall)) ///
mcolor(purple) ///
msymbol(circle) ///
...
stripplot coop_gr if ab=="Rif" & dumb_shit==5, over(repdummy) /// 
 stack center vertical refline(lwidth(0.4) lcolor(black)) separate(dumb_shit) ///
title("Rifampicin, coculture-evolved {it:E. coli}," "co-culture growth rates", size(medlarge) color(black) margin(zero)) ///
ytitle("Co-culture growth rate", size(medsmall)) ///
xtitle("Population name", size(medsmall) margin(vsmall)) ///
mcolor(purple) ///
msymbol(triangle) ///
...
stripplot mono_gr if ab=="Rif" & dumb_shit==9, over(repdummy) /// 
 stack center vertical refline(lwidth(0.4) lcolor(black)) separate(dumb_shit) ///
title("Rifampicin, monoculture-evolved {it:S. enterica}," "monoculture growth rates", size(medlarge) color(black) margin(zero)) ///
ytitle("Monoculture growth rate", size(medsmall)) ///
...
stripplot coop_gr if ab=="Rif" & dumb_shit==9, over(repdummy) /// 
 stack center vertical refline(lwidth(0.4) lcolor(black)) separate(dumb_shit) ///
title("Rifampicin, monoculture-evolved {it:S. enterica}," "co-culture growth rates", size(medlarge) color(black) margin(zero)) ///
ytitle("Co-culture growth rate", size(medsmall)) ///
xtitle("Population name", size(medium) margin(vsmall)) ///
mcolor(gold) ///
msymbol(triangle) ///
...
stripplot mono_gr if ab=="Rif" & dumb_shit==11, over(repdummy) /// 
 stack center vertical refline(lwidth(0.4) lcolor(black)) separate(dumb_shit) ///
title("Rifampicin, coculture-evolved {it:S, enterica}," "monoculture growth rates", size(medlarge) color(black) margin(zero)) ///
ytitle("Monoculture growth rate", size(medsmall)) ///
xtitle("Population name", size(medsmall) margin(vsmall)) ///
mcolor(green) ///
msymbol(circle) ///
...
stripplot coop_gr if ab=="Rif" & dumb_shit==11, over(repdummy) /// 
 stack center vertical refline(lwidth(0.4) lcolor(black)) separate(dumb_shit) ///
title("Rifampicin, coculture-evolved {it:S. enterica}," "co-culture growth rates", size(medlarge) color(black) margin(zero)) ///
ytitle("Co-culture growth rate", size(medsmall)) ///
xtitle("Population name", size(medsmall) margin(vsmall)) ///
mcolor(green) ///
msymbol(triangle) ///
...
stripplot mono_gr if ab=="Amp" & dumb_shit==3, over(repdummy) /// 
 stack center vertical refline(lwidth(0.4) lcolor(black)) separate(dumb_shit) ///
title("Ampicillin, monoculture-evolved {it:E. coli}," "Monoculture growth rates", size(medlarge) color(black) margin(zero)) ///
ytitle("Monoculture growth rate", size(medsmall)) ///
xtitle("Population name", size(medsmall) margin(vsmall)) ///
mcolor(midblue) ///
msymbol(circle) ///
...
stripplot coop_gr if ab=="Amp" & dumb_shit==3, over(repdummy) /// 
 stack center vertical refline(lwidth(0.4) lcolor(black)) separate(dumb_shit) ///
title("Ampicillin, monoculture-evolved {it:E. coli}," "co-culture growth rates", size(medlarge) color(black) margin(zero)) ///
ytitle("Co-culture growth rate", size(medsmall)) ///
xtitle("Population name", size(medsmall) margin(vsmall)) ///
mcolor(midblue) ///
msymbol(triangle) ///
...
stripplot mono_gr if ab=="Amp" & dumb_shit==5, over(repdummy) /// 
 stack center vertical refline(lwidth(0.4) lcolor(black)) separate(dumb_shit) ///
title("Ampicillin, coculture-evolved {it:E. coli}," "monoculture growth rates", size(medlarge) color(black) margin(zero)) ///
ytitle("Monoculture growth rate", size(medsmall)) ///
xtitle("Population name", size(medsmall) margin(vsmall)) ///
mcolor(purple) ///
msymbol(circle) ///
...
stripplot coop_gr if ab=="Amp" & dumb_shit==5, over(repdummy) /// 
 stack center vertical refline(lwidth(0.4) lcolor(black)) separate(dumb_shit) ///
title("Ampicillin, coculture-evolved {it:E. coli}," "co-culture growth rates", size(medlarge) color(black) margin(zero)) ///
ytitle("Co-culture growth rate", size(medsmall)) ///
xtitle("Population name", size(medsmall) margin(vsmall)) ///
mcolor(purple) ///
msymbol(triangle) ///
