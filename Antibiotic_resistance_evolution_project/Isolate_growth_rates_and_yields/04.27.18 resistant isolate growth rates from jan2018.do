...
text(0.9 1.5 "p=0.0062") text(1.1 3.5 "p=0.0024") 
...
text(1.3 1.5 "p=0.0568") text(1.3 3.5 "p=0.0308") 
...
text(0.625 1.5 "p=0.8494") text(0.7 3.5 "p=0.0713") 
...
xtitle("") ///
ylabel(0(0.1)0.8, labsize(medium)) yscale(range(0 0.8)) ///
text(0.65 1.5 "p=0.3349") text(0.75 3.5 "p=0.0219") 
