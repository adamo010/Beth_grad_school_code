...
ranksum area if(ab=="amp" & (spp=="E" | spp=="3xS")), by(spp)
...
ranksum area if(ab=="amp" & (spp=="S" | spp=="3xS")), by(spp)
...
ranksum area if(ab=="amp" & (spp=="3xS" | spp=="M")), by(spp)
ranksum area if(ab=="amp" & (spp=="3xS" | spp=="coop")), by(spp)
ranksum area if(ab=="amp" & (spp=="3xS" | spp=="comp")), by(spp)
