...
by ab, sort : tabstat mic, statistics(median) by(spp) columns(statistics)
...
xlabel(1 `" "{it:E. coli}," "Lactose" "' 2 `" "{it: S. enterica}," "Acetate" "(weakest)" "' 3 `" "{it:M. extorquens}," "Acetate" "' 4 `" "Cooperative" "community" "' 5 `" "Competitive" "community," "Acetate" "', labsize(small)) ///
...
mlcolor(black black black black black) ///
mlwidth(vthin vthin vthin vthin vthin) ///
xlabel(1 `" "{it:E. coli}," "Lactose" "' 2 `" "{it: S. enterica}," "Acetate" "' 3 `" "{it:M. extorquens}," "Acetate" "(weakest)" "' 4 `" "Cooperative" "community" "' 5 `" "Competitive" "community," "Acetate" "', labsize(small)) ///
