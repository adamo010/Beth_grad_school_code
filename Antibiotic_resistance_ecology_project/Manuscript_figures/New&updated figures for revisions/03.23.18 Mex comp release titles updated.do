...
title("Competitive community, all species", color(black) size(medlarge)) ///
xtitle("[Ampicillin] (ug/mL)", size(medium) margin(medium)) ytitle("Normalized OD600", size(medium)) ///
...
legend (colfirst rows(1) order(1 "rep1" 2 "rep2" 3 "rep3") size(medium)) ///
title("Competitive community, {it: E. coli}", color(black) size(medlarge)) ///
xtitle("[Ampicillin] (ug/mL)", size(medium) margin(medium)) ytitle("Normalized CFP (f.u.)", size(medium)) ///
...
legend (colfirst rows(1) order(1 "rep1" 2 "rep2" 3 "rep3") size(medium)) ///
title("Competitive community, {it: S. enterica}", color(black) size(medlarge)) ///
xtitle("[Ampicillin] (ug/mL)", size(medium) margin(medium)) ytitle("Normalized YFP (f.u.)", size(medium)) ///
...
legend (colfirst rows(1) order(1 "rep1" 2 "rep2" 3 "rep3") size(medium)) ///
title("Competitive community, {it: M. extorquens}", color(black) size(medlarge)) ///
xtitle("[Ampicillin] (ug/mL)", size(medium) margin(medium)) ytitle("Normalized RFP (f.u.)", size(medium)) ///
