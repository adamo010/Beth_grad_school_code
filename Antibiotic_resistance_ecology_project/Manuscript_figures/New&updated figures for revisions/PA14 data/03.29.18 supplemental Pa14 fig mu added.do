...
legend(colfirst rows(3) order(1 " " 2 "0{&mu}g/mL" "Ampicillin" 3 " " ///
4 " " 5 "5{&mu}g/mL" "Ampicillin" 6 " " 7 " " 8 "10{&mu}g/mL" "Ampicillin" 9 " " ///
10 " " 11 "25{&mu}g/mL" "Ampicillin" 12 " ") size(medium) symxsize(7)) ///
...
(rcap hiraw loraw typeamp, color(black)), ///
legend(colfirst rows(1) order(1 "0{&mu}g/mL" "Ampicillin" 2 "5{&mu}g/mL" "Ampicillin" 3 "10{&mu}g/mL" "Ampicillin" 4 "25{&mu}g/mL" "Ampicillin") size(medium) symxsize(7)) ///
