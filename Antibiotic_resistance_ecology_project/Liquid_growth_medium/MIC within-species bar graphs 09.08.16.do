...
xlabel( 2 "E. coli" 7 "S. enterica" 12 "M. extorquens", noticks) ///
xtitle("Species") ///
ytitle("MIC (ng/uL)") ///
ylabel(, angle(horizontal)) ///
title("Ampicillin, by species", color(black)) ///
...
xlabel( 2 "E. coli" 7 "S. enterica" 11 "M. extorquens", noticks) ///
ytitle("MIC (ng/uL)") ///
ylabel(, angle(horizontal)) ///
xtitle(" ") ///
title("Tetracycline, by species", color(black)) ///
graphregion(fcolor(white) margin(vsmall))
